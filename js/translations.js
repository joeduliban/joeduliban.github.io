...
        },
        skills: {
            programming: ["Java (Orienté Objet, Android)", "JavaScript/TypeScript (Full-Stack)", "C / C++ (Systèmes embarqués)", "C# (Unity, .NET Core)", "Python (IA, Automatisation, IoT)", "Dart (Flutter Mobile)"],
...
            ar3d: ["Unity (Jeux, AR, Simulations)", "Unreal Engine (C++, Blueprints)", "Vuforia (Reconnaissance AR)", "Blender/FreeCAD/Autodesk (Modélisation 3D)", "Three.js (Visualisation web 3D)"],
...
    },
    ...
    en: {
        ...
        skills: {
            ...
            ar3d: ["Unity (Games, AR, Simulations)", "Unreal Engine (C++, Blueprints)", "Vuforia (AR Recognition)", "Blender/FreeCAD/Autodesk (3D Modeling)", "Three.js (3D web visualization)"],
    ...
    es: {
        ...
        skills: {
            ...
            ar3d: ["Unity (Juegos, RA, Simulaciones)", "Unreal Engine (C++, Blueprints)", "Vuforia (Reconocimiento RA)", "Blender/FreeCAD/Autodesk (Modelado 3D)", "Three.js (Visualización web 3D)"],
